...
#include <quark/channel/channel.h>

// END Includes. /////////////////////////////////////////////////////

#ifndef QUARK_CHANNEL_SPLITTER_H_
#define QUARK_CHANNEL_SPLITTER_H_
...
class channel_splitter : public channel<T> {
     ...
     *       be attached.
     */
    std::vector<quark::channel<T> *> mSinks;
    ...
    void add_channel(quark::channel<T> * channel) {
    ...
    void remove_channel(quark::channel<T> * channel) {
        quark::channel<T> * c;

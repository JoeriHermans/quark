...
namespace quark {
    ...
    const char quark::console_logger::kDebug[] = "debug";
    const char quark::console_logger::kInfo[] = "information";
    const char quark::console_logger::kError[] = "error";
    const char quark::console_logger::kCritical[] = "critical";
    const char quark::console_logger::kType[] = "console";
    ...
    inline void console_logger::spawn_threadpool(const std::size_t numThreads) {
        ...
        mPool = new quark::threadpool(numThreads);
    }
    ...
    void console_logger::debug(const std::string & message) {
        ...
        mPool->enqueue(new quark::console_log_task(logMessage));
    }

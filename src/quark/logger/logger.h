/**
 * An abstract class for the QUARK logger interface.
 *
 * @date                    02 05 2016
...
#include <quark/logger/enum_log_level.h>

// END Includes. /////////////////////////////////////////////////////

#ifndef QUARK_LOGGER_H_
#define QUARK_LOGGER_H_
...
class logger {
    ...
    static void set_logger(quark::logger * logger);

    static quark::logger * get_logger(void);

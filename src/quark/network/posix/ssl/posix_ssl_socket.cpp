...
#include <quark/network/posix/ssl/posix_ssl_socket.h>
#include <quark/io/reader/network/ssl/ssl_reader.h>
#include <quark/io/writer/network/ssl/ssl_writer.h>
...
namespace quark {
    ...
    void posix_ssl_socket::set_ssl_environment(SSL * ssl) {
        ...
        mReader = new quark::ssl_reader(this, ssl);
        mWriter = new quark::ssl_writer(this, ssl);
    }
    ...
    quark::reader * posix_ssl_socket::get_reader(void) const {
        quark::reader * reader;
    ...
    quark::writer * posix_ssl_socket::get_writer(void) const {
        quark::writer * writer;

...
#ifndef QUARK_SERVER_H_
#define QUARK_SERVER_H_
...
class server : public observer {
     ...
     */
    quark::server_socket * mServerSocket;

    // END Private members. //////////////////////////////////////////////////

    // BEGIN Private methods. ////////////////////////////////////////////////

    void set_server_socket(quark::server_socket * socket) {
    ...
    quark::server_socket * get_server_socket(void) const {
    ...
    server(quark::server_socket * socket) {

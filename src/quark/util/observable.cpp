...
namespace quark {
    ...
    bool observable::contains_observer(const quark::observer * observer) const {
        bool contains;
    ...
    void observable::remove_observer(const quark::observer * observer) {
        quark::observer * current;
    ...
    void observable::add_observer(quark::observer * observer) {
